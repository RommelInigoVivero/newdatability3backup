    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('login') }}">PDAO</a>
                </li>
                <li class="nav-item">
...
<div class="center-wrapper">
    <div class="w3-card-4" style="width:65%;">
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <header class="w3-container w3-green">
                <div class="header-content">
                    <h2>Persons with Disability Affairs Office Portal</h2>
                </div>
            </header>

            <div class="row">
                <div class="column w3-container" id="col1">
                    <img src="/CSS/LOGO_DESIGN.png" id="PDAO_LOGO">
                </div>
        ...
        <footer class="w3-container w3-green">
            <h5>©2024City Goverment of Parañaque City. All rights reserved</h5>
        </footer>
    </div>
</div>
